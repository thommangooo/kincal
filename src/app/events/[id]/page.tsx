          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div className="p-8">
              ...
              {event.entity_id && (event.club || event.zone || event.district) && (
                <div className="bg-purple-50 rounded-lg p-6 mt-6 -mx-8">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center space-x-2">
                      ...
                      <div className="w-64 bg-white border border-gray-300 rounded px-3 py-2 text-sm text-gray-600 truncate">
                        {(() => {
                          const { publicIcsUrl } = buildEntityIcsSubscriptionUrls(event.entity_type, event.entity_id)
                          return publicIcsUrl.length > 40 ? `${publicIcsUrl.substring(0, 40)}...` : publicIcsUrl
                        })()}
                      </div>
                      <button
                        onClick={async () => {
